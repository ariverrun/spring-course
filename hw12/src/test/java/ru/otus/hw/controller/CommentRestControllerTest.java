...
class CommentRestControllerTest {
    ...
    @Test
    @SuppressWarnings("null")
    void shouldNotGetCommentsByBookIdForAnon() throws Exception {
        mockMvc.perform(get("/api/v1/comment")
    ...
    @Test
    @SuppressWarnings("null")
    void shouldNotGetCommentByIdForAnon() throws Exception {
        mockMvc.perform(get("/api/v1/comment/{commentId}", 1L))
            .andExpect(status().isUnauthorized())
            .andExpect(content().json(objectMapper.writeValueAsString(getUnauthorizedResponseData())));
    }
    ...
    @Test
    @SuppressWarnings("null")
    void shouldNotListCommentsForAnonWhenBookIdMissing() throws Exception {
        mockMvc.perform(get("/api/v1/comment"))
            .andExpect(status().isUnauthorized())
            .andExpect(content().json(objectMapper.writeValueAsString(getUnauthorizedResponseData())));
    }
