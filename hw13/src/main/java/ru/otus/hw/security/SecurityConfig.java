    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/author", "/api/v1/genre").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/v1/author/*", "/api/v1/genre/*").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/author/*", "/api/v1/genre/*").hasRole("ADMIN")
